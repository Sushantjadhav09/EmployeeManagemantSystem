...
const UpdateEmployeeProfessionalDetails = () => {
    ...
    useEffect(() => {
        const fetchEmployeeData = async () => {
            try {
                const response = await axios.get(`http://localhost:9095/getprofessiondetailsbyid/${employmentCode}`);
    ...
    const handleUpdate = async () => {
        try {
            await axios.put(`http://localhost:9095/updateprofdetails/${formData.employment_code}`, formData);
...
export default UpdateEmployeeProfessionalDetails;
